...
- *Alternatively, if using the embedded version of ARCA Trusted OS (https://www.cysec.com/arca/), we refer the reader to https://github.com/cognifog-eu/iot-edge-gw/blob/main/ARCA_OS.md.
