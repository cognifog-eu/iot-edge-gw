...
- **OS**: Debian GNU/Linux 11 (bullseye) and Debian GNU/Linux 12 (bookworm). These Linux-based OS distributions can be found in the Raspberry Pi Imager (https://www.raspberrypi.com/software/) under the name `Raspberry Pi OS Lite (64-bit)`. Alternatively, if using the embedded version of ARCA Trusted OS (https://www.cysec.com/arca/), we refer the reader to https://github.com/cognifog-eu/iot-edge-gw/blob/main/ARCA_OS.md.
